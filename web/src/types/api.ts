export type TerrainType = 'TerrainPlain' | 'TerrainBlock' | 'TerrainTower' | 'TerrainWater' | 'TerrainLava'

export type OccupantType = 'OccupantNone' | 'OccupantUnit' | 'OccupantBomb' | 'OccupantSoftBlock' | 'OccupantItem'
