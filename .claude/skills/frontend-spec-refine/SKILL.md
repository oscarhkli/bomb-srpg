...
- **Sprite Filename Convention**: Aseprite-exported sprite filenames follow Capitalize-Dash (e.g. `Fighter-Blue.png`, `Stage-Standard.png`, `Button-Neutral.png`) — this comes from the Aseprite tag name, not manual renaming. Flag any spec table listing lowercase or otherwise-cased filenames.
